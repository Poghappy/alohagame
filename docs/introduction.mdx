...
<p align="center">
  <img
    ...
    src="/logo/alohagamebot_transparent_logo_dark.svg"
    alt="AlohaGameBot Logo"
    width="500"
  />
  <img
    className="hidden dark:block"
    src="/logo/alohagamebot_transparent_logo_white.svg"
    alt="AlohaGameBot Logo"
    width="500"
  />
</p>
...
AlohaGameBot is an open-source AI agent that can control a computer desktop to complete tasks for you. It runs in Docker containers on your own infrastructure, giving you a virtual assistant that can:
...
Simply describe what you need done in plain English, and AlohaGameBot will figure out how to do it – clicking buttons, typing text, navigating websites, reading documents, and completing tasks just like a human would.

## Why AlohaGameBot Over Traditional RPA?
